<?php
    include 'header.php';
    $tagihanBookingData = getTagihanData('booking', 'tagihan_id', $_POST['no_invoice']);
...
<div class="container ">
        <!-- FORM BOOKING -->
    <form class="form-cust" method="post" action="data_input.php?category=tgbookUpdate">
        <div class="col-md-6 mx-auto form-bg form-border" >
                <center style="padding-top: 1em;"><h4>Konfirmasi Pembayaran Booking</h4></center>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control " id="usr" name="" value="<?php echo $tagihanData['tagihan_id'] ?>">
                    </div>                   
                    <div class="form-group">
