	...
	function sendMailTagihan($type, $id){
		...
		if ($type == 'booking') {
			...
			$sqlAddon = "
				...
				WHERE `kostin_booking_ao`.`book_id` = '$id'
			";
			...
			foreach ($dataAddon as $addon) {
				$htmlAddon .= '	<tr>
									...
									<td class="col-1">'.$addon['jumlah'].'</td>
									<td class="col-1">Rp. '.number_format($addon['ao_price']).'</td>
									<td class="col-2">Rp. '.number_format($addon['ao_price']*$addon['jumlah']).'</td>
								</tr>
								';
				$ao_price += $addon['ao_price']*$addon['jumlah'];
			}
				...
				<!DOCTYPE html>
					...
					<div class="body-invoice">
						...
						<table class="table">
							...
							<tr>
								<th class="col-kiri">Item</th>
								<th class="col-kiri">Jumlah</th>
								<th class="col-kiri">Harga @</th>
								<th class="col-kanan">Harga Total</th>
							</tr>
							'.$htmlAddon.'
							<tr>
								<td class="col-1" colspan="3">Biaya Kamar Bulan 1</td>
								<td class="col-1">Rp. '.number_format($row3['kamar_harga']).'</td>
							</tr>
							<tr>
								<td class="total col-1" colspan="3">Total </td>
								<td class="total col-1" >Rp. '.number_format($totalInv).'</td>
							</tr>
						</table>
						</div>
					</div>
				...
				<!DOCTYPE html>
					...
					<div class="body-invoice">
						...
						<table class="table">
							...
							'.$htmlAddon.'
							<tr>
								<td class="col-kiri" colspan="3">Biaya Kamar</td>
